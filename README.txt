...
- ExtendedHavenInfoConfig.cs: Example of ModConfig for custom mod settings;
- ExtendedHavenInfoGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ExtendedHavenInfoMain.cs: Main mod class, recieves mod management and general events;
- ExtendedHavenInfoTactical.cs: Example of ModTactical for modifying tactical level;
